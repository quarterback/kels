...
> Canon v5.17, 1092 headwords. Read top to bottom, then produce ONE domain batch.
...
## PART E — The complete current headword list (1092 words — use only these; anything else is a gap to flag)
