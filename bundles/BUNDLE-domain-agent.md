...
> Canon v5.26, 1219 headwords. Read top to bottom, then produce ONE domain batch.
...
## PART E — The complete current headword list (1219 words — use only these; anything else is a gap to flag)
