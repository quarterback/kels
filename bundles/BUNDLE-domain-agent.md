...
> Canon v5.37, 1588 headwords. Read top to bottom, then produce ONE domain batch.
...
## PART E — The complete current headword list (1588 words — use only these; anything else is a gap to flag)
