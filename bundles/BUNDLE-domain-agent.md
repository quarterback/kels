...
> Canon v5.73, 1992 headwords. Read top to bottom, then produce ONE domain batch.
...
Current canon: **v5.73, 1992 headwords.** Authoritative source: the repository —
`coursebook/nelo-kel-coursebook.md` (the language) and `college/kels-kolegi-charter.md`
(rules + full ruling log §1–§142).
...
## PART F — The complete current headword list (1992 words — use only these; anything else is a gap to flag)
