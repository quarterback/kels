...
> Canon v5.57, 1824 headwords. Read top to bottom, then produce ONE domain batch.
...
## PART F — The complete current headword list (1824 words — use only these; anything else is a gap to flag)
