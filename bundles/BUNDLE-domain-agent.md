...
> Canon v5.42, 1649 headwords. Read top to bottom, then produce ONE domain batch.
...
## PART E — The complete current headword list (1649 words — use only these; anything else is a gap to flag)
