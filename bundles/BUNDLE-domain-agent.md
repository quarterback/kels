...
> Canon v5.58, 1831 headwords. Read top to bottom, then produce ONE domain batch.
...
Current canon: **v5.58, 1831 headwords.** Authoritative source: the repository —
`coursebook/nelo-kel-coursebook.md` (the language) and `college/kels-kolegi-charter.md`
(rules + full ruling log §1–§127).
...
Canon v5.58. Full list in data/headwords.txt.
...
## PART F — The complete current headword list (1831 words — use only these; anything else is a gap to flag)
