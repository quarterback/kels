...
> Canon v5.26, 1231 headwords. Read top to bottom, then produce ONE domain batch.
...
Current canon: **v5.26, 1231 headwords.** Authoritative source: the repository —
...
## PART E — The complete current headword list (1231 words — use only these; anything else is a gap to flag)
