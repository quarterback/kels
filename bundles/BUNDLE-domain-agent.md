...
> Canon v5.27, 1260 headwords. Read top to bottom, then produce ONE domain batch.
...
Current canon: **v5.27, 1260 headwords.** Authoritative source: the repository —
`coursebook/nelo-kel-coursebook.md` (the language) and `college/kels-kolegi-charter.md`
(rules + full ruling log §1–§93).
...
## PART E — The complete current headword list (1260 words — use only these; anything else is a gap to flag)
