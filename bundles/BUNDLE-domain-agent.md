...
> Canon v5.30, 1461 headwords. Read top to bottom, then produce ONE domain batch.
...
Current canon: **v5.30, 1461 headwords.** Authoritative source: the repository —
`coursebook/nelo-kel-coursebook.md` (the language) and `college/kels-kolegi-charter.md`
(rules + full ruling log §1–§97).
...
## PART E — The complete current headword list (1461 words — use only these; anything else is a gap to flag)
