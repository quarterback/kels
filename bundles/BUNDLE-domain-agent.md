...
> Canon v5.65, 1873 headwords. Read top to bottom, then produce ONE domain batch.
...
Current canon: **v5.65, 1873 headwords.** Authoritative source: the repository —
`coursebook/nelo-kel-coursebook.md` (the language) and `college/kels-kolegi-charter.md`
(rules + full ruling log §1–§134).
...
## PART F — The complete current headword list (1873 words — use only these; anything else is a gap to flag)
