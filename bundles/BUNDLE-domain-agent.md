...
> Canon v5.71, 1946 headwords. Read top to bottom, then produce ONE domain batch.
...
Current canon: **v5.71, 1946 headwords.** Authoritative source: the repository —
`coursebook/nelo-kel-coursebook.md` (the language) and `college/kels-kolegi-charter.md`
(rules + full ruling log §1–§140).
...
## PART F — The complete current headword list (1946 words — use only these; anything else is a gap to flag)
