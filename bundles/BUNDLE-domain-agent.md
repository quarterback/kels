...
> Canon v5.12, 1047 headwords. Read top to bottom, then produce ONE domain batch.
...
## PART C — Verb-derivation (use this to build verb variants instead of coining new roots)
...
## PART E — The complete current headword list (1047 words — use only these; anything else is a gap to flag)
