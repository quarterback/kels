...
> Canon v5.13, 1051 headwords. Read top to bottom, then produce ONE domain batch.
...
## PART E — The complete current headword list (1051 words — use only these; anything else is a gap to flag)
