...
> Canon v5.28, 1289 headwords. Read top to bottom, then produce ONE domain batch.
...
Current canon: **v5.28, 1289 headwords.** Authoritative source: the repository —
`coursebook/nelo-kel-coursebook.md` (the language) and `college/kels-kolegi-charter.md`
(rules + full ruling log §1–§94).
...
## PART E — The complete current headword list (1289 words — use only these; anything else is a gap to flag)
