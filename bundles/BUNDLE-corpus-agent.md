...
> Canon v5.29, 1350 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.29, 1350 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1350 words; use only these)
...
Canon v5.29. Full list in data/headwords.txt.
