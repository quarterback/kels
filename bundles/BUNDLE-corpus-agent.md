...
> Canon v5.59, 1832 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.59, 1832 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1832 words; use only these)
...
Canon v5.59. Full list in data/headwords.txt.
