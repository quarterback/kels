...
> Canon v5.67, 1902 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.67, 1902 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1902 words; use only these)
...
Canon v5.67. Full list in data/headwords.txt.
