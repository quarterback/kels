...
> Canon v5.42, 1649 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.42, 1649 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1649 words; use only these)
...
Canon v5.42. Full list in data/headwords.txt.
