...
> Canon v5.41, 1650 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.41, 1650 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1650 words; use only these)
...
Canon v5.41. Full list in data/headwords.txt.
