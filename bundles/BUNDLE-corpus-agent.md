...
> Canon v5.68, 1904 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.68, 1904 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1904 words; use only these)
...
Canon v5.68. Full list in data/headwords.txt.
