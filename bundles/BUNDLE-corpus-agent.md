...
> Canon v5.63, 1865 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.63, 1865 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1865 words; use only these)
...
Canon v5.63. Full list in data/headwords.txt.
