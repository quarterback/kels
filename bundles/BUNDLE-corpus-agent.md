...
> Canon v5.73, 1992 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.73, 1992 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1992 words; use only these)
...
Canon v5.73. Full list in data/headwords.txt.
