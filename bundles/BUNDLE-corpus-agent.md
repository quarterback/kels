...
> Canon v5.55, 1821 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.55, 1821 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1821 words; use only these)
...
Canon v5.55. Full list in data/headwords.txt.
