...
> Canon v5.53, 1815 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.53, 1815 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1815 words; use only these)
...
Canon v5.53. Full list in data/headwords.txt.
