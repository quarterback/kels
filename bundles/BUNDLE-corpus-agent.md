...
> Canon v5.49, 1735 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.49, 1735 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1735 words; use only these)
...
Canon v5.49. Full list in data/headwords.txt.
