...
> Canon v5.77, 2003 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.77, 2003 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (2003 words; use only these)
...
Canon v5.77. Full list in data/headwords.txt.
