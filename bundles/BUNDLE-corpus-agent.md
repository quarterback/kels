...
> Canon v5.28, 1289 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.28, 1289 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1289 words; use only these)
...
Canon v5.28. Full list in data/headwords.txt.
