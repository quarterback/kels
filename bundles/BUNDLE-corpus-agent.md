...
> Canon v5.64, 1868 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.64, 1868 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1868 words; use only these)
...
Canon v5.64. Full list in data/headwords.txt.
