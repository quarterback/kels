...
> Canon v5.56, 1823 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.56, 1823 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1823 words; use only these)
...
Canon v5.56. Full list in data/headwords.txt.
