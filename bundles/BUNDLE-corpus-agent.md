...
> Canon v5.54, 1820 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.54, 1820 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1820 words; use only these)
...
Canon v5.54. Full list in data/headwords.txt.
