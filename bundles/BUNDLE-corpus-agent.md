...
> Canon v5.74, 2000 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.74, 2000 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (2000 words; use only these)
...
Canon v5.74. Full list in data/headwords.txt.
