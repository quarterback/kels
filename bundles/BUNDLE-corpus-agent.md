...
> Canon v5.57, 1824 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.57, 1824 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1824 words; use only these)
...
Canon v5.57. Full list in data/headwords.txt.
