...
> Canon v5.33, 1533 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.33, 1533 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1533 words; use only these)
...
Canon v5.33. Full list in data/headwords.txt.
