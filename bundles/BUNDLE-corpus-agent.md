...
> Canon v5.37, 1588 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.37, 1588 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1588 words; use only these)
...
Canon v5.37. Full list in data/headwords.txt.
