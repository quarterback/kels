...
> Canon v5.22, 1212 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.22, 1212 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1212 words; use only these)
...
Canon v5.22. Full list in data/headwords.txt.
