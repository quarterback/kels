...
> Canon v5.66, 1899 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.66, 1899 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1899 words; use only these)
...
Canon v5.66. Full list in data/headwords.txt.
