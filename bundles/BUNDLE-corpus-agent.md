...
> Canon v5.60, 1838 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.60, 1838 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1838 words; use only these)
...
Canon v5.60. Full list in data/headwords.txt.
