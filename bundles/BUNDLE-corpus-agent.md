...
> Canon v5.26, 1231 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.26, 1231 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1231 words; use only these)
...
Canon v5.26. Full list in data/headwords.txt.
