...
> Canon v5.18, 1126 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.18, 1126 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1126 words; use only these)
...
Canon v5.18. Full list in data/headwords.txt.
