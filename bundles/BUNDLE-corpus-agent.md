...
> Canon v5.30, 1461 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.30, 1461 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1461 words; use only these)
...
Canon v5.30. Full list in data/headwords.txt.
