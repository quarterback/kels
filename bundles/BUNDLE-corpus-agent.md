...
> Canon v5.62, 1854 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.62, 1854 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1854 words; use only these)
...
Canon v5.62. Full list in data/headwords.txt.
