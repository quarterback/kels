...
> Canon v5.36, 1551 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.36, 1551 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1551 words; use only these)
...
Canon v5.36. Full list in data/headwords.txt.
