...
> Canon v5.71, 1946 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.71, 1946 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1946 words; use only these)
...
Canon v5.71. Full list in data/headwords.txt.
