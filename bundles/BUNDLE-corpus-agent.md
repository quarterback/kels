...
> Canon v5.31, 1494 headwords. Read top to bottom, then produce ONE text + gap-list.
...
Nelôxi is at version 5.31, 1494 headwords. The founder rules; you contribute. Nothing you
...
## SECTION 6 — THE ATTESTED HEADWORD LIST (1494 words; use only these)
...
Canon v5.31. Full list in data/headwords.txt.
