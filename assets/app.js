...
(function () {
  ...
  var PAGES = {
    ...
    numerals:    { title: "Numbers — the dozenal page", sub: "The digits, the powers of twelve, and a converter for any number", ext: "numbers.html", group: "Reference" },
    measures:    { title: "Weights, measures & money", sub: "The Viennese imperial system in pure base twelve", file: "world/measures.md", group: "Reference", toc: true },
  ...
  var SECTION_PAGES = {
    ...
    world: {
      ...
      cards: ["neloxialore", "settlements", "modernmodel", "expandedlore", "yemenilore", "meridianlore", "valdorialore", "skarialore", "sarmatialore", "zaryanova", "neighbours", "geography", "gazetteer", "names", "namegen", "toponymy", "toponyms", "bruceplan", "numerals", "measures", "exonyms", "governance", "boundaries", "atlantalore", "africanbloc"]
    },
    college: {
      kicker: "Canon",
      title: "College",
