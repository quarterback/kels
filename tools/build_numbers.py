...
const COEF={
 ...
 /* sab- = 7 anchors the Arabic series. 6× is PERSIAN: shesh /ʃeʃ/ digests
    through the ş → x rule to xex-, keeping the Red Sea column Persian-sourced
    throughout — laxô, krōr and xex- all come off the same water. */
 6:{2:"tin",3:"sil",4:"arb",5:"xam",6:"xex",7:"sab",8:"tam",9:"tis",10:"ašr",11:"ahad"}};
