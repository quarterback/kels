...
differently (Nelôxi writes [ʃ] as *x* and lacks native *f, z, sch*, but a German-named town keeps
its *f*, *sch*, *z*). This is deliberate and realistic; the map shows its seams.

**The one thing that is NOT allowed:** characters that exist in *neither* the source language nor
Nelôxi — e.g. *î, û, â*. Those are errors, not fossils. Nelôxi uses **ô** [ɤ] and the macrons
**ā ē ī ō ū**. Foreign letters (f, sch, z, sz, w) may stay as scars; invented diacritics may not.

The **x = [ks] proper-noun rule** (§47) applies: in place-names *x* may take the archaic [ks]
value, especially in official/ceremonial forms.

Each entry is tagged by naming layer:
**(native)** descriptive Finnic · **(nativized)** loan digested into Nelôxi · **(raw loan)** foreign
spelling kept as a scar · **(archaic-x)** ceremonial [ks] · **(hybrid)** loan root + native element.
