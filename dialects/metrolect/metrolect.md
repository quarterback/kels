...
The metrolect runs a **register gradient** — the *clip* rules below are strongest
at the casual/harbor end and weaken toward the capital/official end, which is the
standard itself.
...
2. **Geminate l·l → l**: *famīl·la* → *famīl* "family". This is the headline case
   ...
   keeps it full.
3. **-ē → -e (short)** in unstressed finals: *semprē* → *sempre*, *felīç* unchanged
   (stressed).
...
accent. Slavic-stratum vocabulary is coined per charter §30.
