...
`lexicon-B-*` (Batch 1, terrain), `lexicon-C-*` (Batch 2, domestic core), and `lexicon-A-*`
(Batch 3, admin & maritime — a further ~30 doublets: durô↔marsā, xip↔markab, kalā↔xūt,
handlôji↔tāžər, sīgel↔xātam, aktô↔warga, rīgô↔dawla, …). 116 Saharannaise headwords across
three batches, federated here against their mainland counterparts.*
