# Nelôxi — Idioms & Sayings

*The phrase-level texture: fixed expressions that carry the culture the way single words can't. An
idiom is a picture the whole speech-community agreed to keep. These are canon — use them whole, and
don't translate them literally into a text (that kills them). New idioms are ruled like words
(charter §NNN); each is grounded in the metaphor fields of `college/METAPHOR-FIELDS.md`.*

---

## Freedom

> **Säs eläji kōrrô karrēl ja menjā sigôkarnt.**
> *lit.* "Your animals are running in the street eating ham."
> **= freedom — the lived kind:** everything let loose, nobody minding the gate, license bordering
> on happy chaos.

Not the legal *libertā* (the right, the institution) — this is freedom you can *see*: the yard
thrown open, the livestock in the road gorging on what should have been the winter ham. It carries a
wry, earthy edge — freedom as glorious disorder, said half in envy and half in warning. The lived
counterpart the pass-back (§123) left open is filled not by a word but by an **image**, which is
better. Clipped, people just say **säs eläji karrēl** "your animals in the street" — the rest is
understood.

*(Coins this made canon: **eläji** "animal, a living thing"; **sigôkarn** "pork, ham.")*

---

## Fate

> **Mer donā, ja mer votā.**
> *"The sea gives, and the sea takes."*
> **= what will be, will be;** fortune is tidal, not earned or deserved.

The founding proverb (see `reader/folktale-fisher-sea.md`). It is why fate is **merjagô** "the share
the sea deals you" (§123), not a borrowed *fatum* — the saying came first, the word grew from it.
...
1. The image must sit in a **metaphor field** (sea, salt & scale, black-book, net, hearth, parish,
   pitch) — an idiom is that field speaking in a full sentence.
2. Build it from **attested words**; if it needs a new one, coin that word by the §122 doctrine
   (native metaphor) and merge it with the idiom.
3. Gloss it with its **register and edge** (wry, solemn, coarse, tender) — an idiom without a stance
   is just a sentence.
4. Record it here and rule it in the charter.
