...
Deictic adverbs of time and place **reduplicate for immediacy**: *nyt* "now" → **nytnyt** "right now, this instant"; *sīn* "here" → **sīnsīn** "right here"; *sāl* "there" → **sālsāl** "just over there."

Because time-words take the local cases, *nyt* also inflects: goal-case **nytlä** ("toward now") means *soon, presently, in a bit* — a promise without a deadline — and source-case **nytelt** means *from now on, henceforth*. The full ladder, most urgent to least:

> **nytnyt** — immediately · **nyt** — now · **nytlä** — just now, in a bit · **nytelt** — from now on

*Ka sä tulē?* — *Nytlä.* ("Are you coming?" — "Just now." Do not hold your breath.)
