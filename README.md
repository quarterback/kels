...
One grammar (with one licensed maritime bend), one orthographic agreement (`saharannaise/COMMON-REGISTER.md`), five divergent dictionaries — the Lisbon / Brasília / Luanda / Macau settlement of this language, with a fifth chair drawn up from the far south. The East fork stands deliberately outside that shared-spine sentence: same dictionary, its **own** Circassian-led grammar, legal only in its own namespace — the one seat that proves the sturdiness thesis in the other direction.
